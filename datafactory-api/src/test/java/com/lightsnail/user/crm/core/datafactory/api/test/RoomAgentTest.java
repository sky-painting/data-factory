...
public class RoomAgentTest {
    ...
    /**
     * crm服务
     * snail_app_user_crm.room_agent
     */
    @Test
    public void testGenerateFromRoomAgent(){
        DataBuildRequestVo dataFactoryRequestVo = new DataBuildRequestVo();
        dataFactoryRequestVo.setGenerateCount(100);
        dataFactoryRequestVo.setModuleDesc("代理人基本信息管理");
        dataFactoryRequestVo.setPersistRequest(0);
        dataFactoryRequestVo.setProjectName("租房平台-crm用户服务");
        dataFactoryRequestVo.setModuleName("crm-代理人信息模块");
